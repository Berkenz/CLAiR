        ...
        child: SingleChildScrollView(
          ...
          child: Column(children: [
            Row(children: [
              ...
              const Spacer(),
              Text('Settings', style: GoogleFonts.nunito(fontSize: 18, fontWeight: FontWeight.w700, color: AppColors.textDark)),
              const Spacer(),
            ...
            Container(
              ...
              child: user?.photoUrl != null
                  ? ClipRRect(borderRadius: BorderRadius.circular(22), child: Image.network(user!.photoUrl!, fit: BoxFit.cover))
                  : Center(child: Text(initials, style: GoogleFonts.nunito(fontSize: 24, fontWeight: FontWeight.w800, color: AppColors.accent))),
            ),
            const SizedBox(height: 12),
            Text(name, style: GoogleFonts.nunito(fontSize: 18, fontWeight: FontWeight.w800, color: AppColors.textDark)),
            Text(user?.email ?? '', style: GoogleFonts.nunito(fontSize: 13, color: AppColors.textMid)),
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Text('Edit Profile', style: GoogleFonts.nunito(fontSize: 12, fontWeight: FontWeight.w700, color: AppColors.accent)),
              ),
            ),
            const SizedBox(height: 28),
            ...
            _section('App', [
              _row(Icons.palette_outlined, 'Appearance', () => Navigator.push(context, MaterialPageRoute(builder: (_) => const AppearanceScreen()))),
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Center(child: Text('Log Out', style: GoogleFonts.nunito(fontSize: 14, fontWeight: FontWeight.w700, color: const Color(0xFFDC4C4C)))),
              ),
            ),
          ]),
        ),
  ...
  Widget _section(String title, List<Widget> rows) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Padding(
        ...
        child: Text(title, style: GoogleFonts.nunito(fontSize: 13, fontWeight: FontWeight.w700, color: AppColors.textMid)),
      ),
      Container(
        decoration: BoxDecoration(
          color: Colors.white,
        ...
        child: Column(children: [
          for (int i = 0; i < rows.length; i++) ...[
            rows[i],
            if (i < rows.length - 1) const Divider(height: 1, indent: 48, color: AppColors.border),
          ],
        ]),
      ),
    ]);
      ...
      child: InkWell(
        ...
        child: Padding(
          ...
          child: Row(children: [
            ...
            Expanded(child: Text(label, style: GoogleFonts.nunito(fontSize: 14, fontWeight: FontWeight.w500, color: AppColors.textDark))),
